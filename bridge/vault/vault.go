...
//
// Solidity: function BURN_CALL_REQUEST_METADATA_TYPE() constant returns(uint8)
...
//
// Solidity: function BURN_REQUEST_METADATA_TYPE() constant returns(uint8)
...
//
// Solidity: function BURN_TO_CONTRACT_REQUEST_METADATA_TYPE() constant returns(uint8)
...
//
// Solidity: function CURRENT_NETWORK_ID() constant returns(uint8)
...
//
// Solidity: function parseCalldataFromBurnInst(bytes inst) constant returns(VaultBurnInstData, VaultRedepositOptions, bytes)
func (_Vault *VaultCaller) ParseCalldataFromBurnInst(opts *bind.CallOpts, inst []byte) (VaultBurnInstData, VaultRedepositOptions, []byte, error) {
	var (
		ret0 = new(VaultBurnInstData)
		ret1 = new(VaultRedepositOptions)
		ret2 = new([]byte)
	)
	out := &[]interface{}{
		ret0,
...
//
// Solidity: function deposit_V2(string incognitoAddress) returns()
