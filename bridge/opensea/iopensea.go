...
// IopenseaABI is the input ABI used to generate the binding from.
// Deprecated: Use IopenseaMetaData.ABI instead.
var IopenseaABI = IopenseaMetaData.ABI

// Iopensea is an auto generated Go binding around an Ethereum contract.
type Iopensea struct {
	IopenseaCaller     // Read-only binding to the contract
	IopenseaTransactor // Write-only binding to the contract
	IopenseaFilterer   // Log filterer for contract events
}
...
// IopenseaSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type IopenseaSession struct {
	Contract     *Iopensea         // Generic contract binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// IopenseaCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type IopenseaCallerSession struct {
	Contract *IopenseaCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts   // Call options to use throughout this session
}

// IopenseaTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type IopenseaTransactorSession struct {
	Contract     *IopenseaTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts   // Transaction auth options to use throughout this session
}
...
func NewIopensea(address common.Address, backend bind.ContractBackend) (*Iopensea, error) {
	contract, err := bindIopensea(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &Iopensea{IopenseaCaller: IopenseaCaller{contract: contract}, IopenseaTransactor: IopenseaTransactor{contract: contract}, IopenseaFilterer: IopenseaFilterer{contract: contract}}, nil
}
...
func NewIopenseaCaller(address common.Address, caller bind.ContractCaller) (*IopenseaCaller, error) {
	contract, err := bindIopensea(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &IopenseaCaller{contract: contract}, nil
}
...
func NewIopenseaTransactor(address common.Address, transactor bind.ContractTransactor) (*IopenseaTransactor, error) {
	contract, err := bindIopensea(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &IopenseaTransactor{contract: contract}, nil
}
...
func NewIopenseaFilterer(address common.Address, filterer bind.ContractFilterer) (*IopenseaFilterer, error) {
	contract, err := bindIopensea(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &IopenseaFilterer{contract: contract}, nil
}

// bindIopensea binds a generic wrapper to an already deployed contract.
func bindIopensea(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(IopenseaABI))
	if err != nil {
		return nil, err
	}
...
func (_Iopensea *IopenseaRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _Iopensea.Contract.IopenseaCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_Iopensea *IopenseaRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Iopensea.Contract.IopenseaTransactor.contract.Transfer(opts)
}
...
func (_Iopensea *IopenseaRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _Iopensea.Contract.IopenseaTransactor.contract.Transact(opts, method, params...)
}
...
func (_Iopensea *IopenseaCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _Iopensea.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_Iopensea *IopenseaTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Iopensea.Contract.contract.Transfer(opts)
}
...
func (_Iopensea *IopenseaTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _Iopensea.Contract.contract.Transact(opts, method, params...)
}
...
func (_Iopensea *IopenseaCaller) GetCounter(opts *bind.CallOpts, offerer common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Iopensea.contract.Call(opts, &out, "getCounter", offerer)
...
func (_Iopensea *IopenseaSession) GetCounter(offerer common.Address) (*big.Int, error) {
	return _Iopensea.Contract.GetCounter(&_Iopensea.CallOpts, offerer)
}
...
func (_Iopensea *IopenseaCaller) GetOrderHash(opts *bind.CallOpts, order OrderComponents) ([32]byte, error) {
	var out []interface{}
	err := _Iopensea.contract.Call(opts, &out, "getOrderHash", order)
...
func (_Iopensea *IopenseaSession) GetOrderHash(order OrderComponents) ([32]byte, error) {
	return _Iopensea.Contract.GetOrderHash(&_Iopensea.CallOpts, order)
}
...
func (_Iopensea *IopenseaCaller) GetOrderStatus(opts *bind.CallOpts, orderHash [32]byte) (struct {
	IsValidated bool
	IsCancelled bool
	TotalFilled *big.Int
	TotalSize   *big.Int
	...
	var out []interface{}
	err := _Iopensea.contract.Call(opts, &out, "getOrderStatus", orderHash)
...
//
// Solidity: function getOrderStatus(bytes32 orderHash) view returns(bool isValidated, bool isCancelled, uint256 totalFilled, uint256 totalSize)
func (_Iopensea *IopenseaSession) GetOrderStatus(orderHash [32]byte) (struct {
	IsValidated bool
	IsCancelled bool
	TotalFilled *big.Int
	TotalSize   *big.Int
}, error) {
	return _Iopensea.Contract.GetOrderStatus(&_Iopensea.CallOpts, orderHash)
}

// GetOrderStatus is a free data retrieval call binding the contract method 0x46423aa7.
//
// Solidity: function getOrderStatus(bytes32 orderHash) view returns(bool isValidated, bool isCancelled, uint256 totalFilled, uint256 totalSize)
func (_Iopensea *IopenseaCallerSession) GetOrderStatus(orderHash [32]byte) (struct {
	IsValidated bool
	IsCancelled bool
	TotalFilled *big.Int
	TotalSize   *big.Int
...
func (_Iopensea *IopenseaCaller) Information(opts *bind.CallOpts) (struct {
	Version           string
	DomainSeparator   [32]byte
	ConduitController common.Address
}, error) {
	var out []interface{}
	err := _Iopensea.contract.Call(opts, &out, "information")
...
//
// Solidity: function information() view returns(string version, bytes32 domainSeparator, address conduitController)
func (_Iopensea *IopenseaSession) Information() (struct {
	Version           string
	DomainSeparator   [32]byte
	ConduitController common.Address
}, error) {
	return _Iopensea.Contract.Information(&_Iopensea.CallOpts)
}

// Information is a free data retrieval call binding the contract method 0xf47b7740.
//
// Solidity: function information() view returns(string version, bytes32 domainSeparator, address conduitController)
func (_Iopensea *IopenseaCallerSession) Information() (struct {
	Version           string
	DomainSeparator   [32]byte
	ConduitController common.Address
}, error) {
...
func (_Iopensea *IopenseaCaller) Name(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Iopensea.contract.Call(opts, &out, "name")
...
func (_Iopensea *IopenseaSession) Name() (string, error) {
	return _Iopensea.Contract.Name(&_Iopensea.CallOpts)
}
...
func (_Iopensea *IopenseaTransactor) Cancel(opts *bind.TransactOpts, orders []OrderComponents) (*types.Transaction, error) {
	return _Iopensea.contract.Transact(opts, "cancel", orders)
}
...
func (_Iopensea *IopenseaSession) Cancel(orders []OrderComponents) (*types.Transaction, error) {
	return _Iopensea.Contract.Cancel(&_Iopensea.TransactOpts, orders)
}
...
func (_Iopensea *IopenseaTransactor) FulfillAdvancedOrder(opts *bind.TransactOpts, advancedOrder AdvancedOrder, criteriaResolvers []CriteriaResolver, fulfillerConduitKey [32]byte, recipient common.Address) (*types.Transaction, error) {
	return _Iopensea.contract.Transact(opts, "fulfillAdvancedOrder", advancedOrder, criteriaResolvers, fulfillerConduitKey, recipient)
}
...
func (_Iopensea *IopenseaSession) FulfillAdvancedOrder(advancedOrder AdvancedOrder, criteriaResolvers []CriteriaResolver, fulfillerConduitKey [32]byte, recipient common.Address) (*types.Transaction, error) {
	return _Iopensea.Contract.FulfillAdvancedOrder(&_Iopensea.TransactOpts, advancedOrder, criteriaResolvers, fulfillerConduitKey, recipient)
}
...
func (_Iopensea *IopenseaTransactor) FulfillAvailableAdvancedOrders(opts *bind.TransactOpts, advancedOrders []AdvancedOrder, criteriaResolvers []CriteriaResolver, offerFulfillments [][]FulfillmentComponent, considerationFulfillments [][]FulfillmentComponent, fulfillerConduitKey [32]byte, recipient common.Address, maximumFulfilled *big.Int) (*types.Transaction, error) {
	return _Iopensea.contract.Transact(opts, "fulfillAvailableAdvancedOrders", advancedOrders, criteriaResolvers, offerFulfillments, considerationFulfillments, fulfillerConduitKey, recipient, maximumFulfilled)
}
...
func (_Iopensea *IopenseaSession) FulfillAvailableAdvancedOrders(advancedOrders []AdvancedOrder, criteriaResolvers []CriteriaResolver, offerFulfillments [][]FulfillmentComponent, considerationFulfillments [][]FulfillmentComponent, fulfillerConduitKey [32]byte, recipient common.Address, maximumFulfilled *big.Int) (*types.Transaction, error) {
	return _Iopensea.Contract.FulfillAvailableAdvancedOrders(&_Iopensea.TransactOpts, advancedOrders, criteriaResolvers, offerFulfillments, considerationFulfillments, fulfillerConduitKey, recipient, maximumFulfilled)
}
...
func (_Iopensea *IopenseaTransactor) FulfillAvailableOrders(opts *bind.TransactOpts, orders []Order, offerFulfillments [][]FulfillmentComponent, considerationFulfillments [][]FulfillmentComponent, fulfillerConduitKey [32]byte, maximumFulfilled *big.Int) (*types.Transaction, error) {
	return _Iopensea.contract.Transact(opts, "fulfillAvailableOrders", orders, offerFulfillments, considerationFulfillments, fulfillerConduitKey, maximumFulfilled)
}
...
func (_Iopensea *IopenseaSession) FulfillAvailableOrders(orders []Order, offerFulfillments [][]FulfillmentComponent, considerationFulfillments [][]FulfillmentComponent, fulfillerConduitKey [32]byte, maximumFulfilled *big.Int) (*types.Transaction, error) {
	return _Iopensea.Contract.FulfillAvailableOrders(&_Iopensea.TransactOpts, orders, offerFulfillments, considerationFulfillments, fulfillerConduitKey, maximumFulfilled)
}
...
func (_Iopensea *IopenseaTransactor) FulfillBasicOrder(opts *bind.TransactOpts, parameters BasicOrderParameters) (*types.Transaction, error) {
	return _Iopensea.contract.Transact(opts, "fulfillBasicOrder", parameters)
}
...
func (_Iopensea *IopenseaSession) FulfillBasicOrder(parameters BasicOrderParameters) (*types.Transaction, error) {
	return _Iopensea.Contract.FulfillBasicOrder(&_Iopensea.TransactOpts, parameters)
}
...
func (_Iopensea *IopenseaTransactor) FulfillOrder(opts *bind.TransactOpts, order Order, fulfillerConduitKey [32]byte) (*types.Transaction, error) {
	return _Iopensea.contract.Transact(opts, "fulfillOrder", order, fulfillerConduitKey)
}
...
func (_Iopensea *IopenseaSession) FulfillOrder(order Order, fulfillerConduitKey [32]byte) (*types.Transaction, error) {
	return _Iopensea.Contract.FulfillOrder(&_Iopensea.TransactOpts, order, fulfillerConduitKey)
}
...
func (_Iopensea *IopenseaTransactor) IncrementCounter(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Iopensea.contract.Transact(opts, "incrementCounter")
}
...
func (_Iopensea *IopenseaSession) IncrementCounter() (*types.Transaction, error) {
	return _Iopensea.Contract.IncrementCounter(&_Iopensea.TransactOpts)
}
...
func (_Iopensea *IopenseaTransactor) MatchAdvancedOrders(opts *bind.TransactOpts, orders []AdvancedOrder, criteriaResolvers []CriteriaResolver, fulfillments []Fulfillment) (*types.Transaction, error) {
	return _Iopensea.contract.Transact(opts, "matchAdvancedOrders", orders, criteriaResolvers, fulfillments)
}
...
func (_Iopensea *IopenseaSession) MatchAdvancedOrders(orders []AdvancedOrder, criteriaResolvers []CriteriaResolver, fulfillments []Fulfillment) (*types.Transaction, error) {
	return _Iopensea.Contract.MatchAdvancedOrders(&_Iopensea.TransactOpts, orders, criteriaResolvers, fulfillments)
}
...
func (_Iopensea *IopenseaTransactor) MatchOrders(opts *bind.TransactOpts, orders []Order, fulfillments []Fulfillment) (*types.Transaction, error) {
	return _Iopensea.contract.Transact(opts, "matchOrders", orders, fulfillments)
}
...
func (_Iopensea *IopenseaSession) MatchOrders(orders []Order, fulfillments []Fulfillment) (*types.Transaction, error) {
	return _Iopensea.Contract.MatchOrders(&_Iopensea.TransactOpts, orders, fulfillments)
}
...
func (_Iopensea *IopenseaTransactor) Validate(opts *bind.TransactOpts, orders []Order) (*types.Transaction, error) {
	return _Iopensea.contract.Transact(opts, "validate", orders)
}
...
func (_Iopensea *IopenseaSession) Validate(orders []Order) (*types.Transaction, error) {
	return _Iopensea.Contract.Validate(&_Iopensea.TransactOpts, orders)
}
