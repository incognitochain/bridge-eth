...
// GetOrderHash is a paid mutator transaction binding the contract method 0xe9f713ad.
//
// Solidity: function getOrderHash((address,uint8,address,address,uint256,uint256,address,uint256,uint256,uint256,(uint16,address)[],uint256,bytes) order) returns(bytes32)
func (_BlurExchange *BlurExchangeTransactor) GetOrderHash(opts *bind.TransactOpts, order Order) (*types.Transaction, error) {
	return _BlurExchange.contract.Transact(opts, "getOrderHash", order)
}

// GetOrderHash is a paid mutator transaction binding the contract method 0xe9f713ad.
//
// Solidity: function getOrderHash((address,uint8,address,address,uint256,uint256,address,uint256,uint256,uint256,(uint16,address)[],uint256,bytes) order) returns(bytes32)
func (_BlurExchange *BlurExchangeSession) GetOrderHash(order Order) (*types.Transaction, error) {
	return _BlurExchange.Contract.GetOrderHash(&_BlurExchange.TransactOpts, order)
}

// GetOrderHash is a paid mutator transaction binding the contract method 0xe9f713ad.
//
// Solidity: function getOrderHash((address,uint8,address,address,uint256,uint256,address,uint256,uint256,uint256,(uint16,address)[],uint256,bytes) order) returns(bytes32)
func (_BlurExchange *BlurExchangeTransactorSession) GetOrderHash(order Order) (*types.Transaction, error) {
	return _BlurExchange.Contract.GetOrderHash(&_BlurExchange.TransactOpts, order)
}
