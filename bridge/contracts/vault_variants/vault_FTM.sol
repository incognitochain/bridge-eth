...
contract VaultFTM {
    ...
    */
    uint8 constant public CURRENT_NETWORK_ID = 4; // Fantom
    uint8 constant public BURN_REQUEST_METADATA_TYPE = 155;
    uint8 constant public BURN_TO_CONTRACT_REQUEST_METADATA_TYPE = 156;
    ...
    */
    ...
    function execute(
        ...
        address verifier = verifySignData(abi.encode(newPreSignData(Prefix.FTM_EXECUTE_SIGNATURE, token, timestamp, amount), recipientToken, exchangeAddress, callData), signData);
