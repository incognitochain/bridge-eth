...
contract VaultPLG {
    ...
    */
    uint8 constant public CURRENT_NETWORK_ID = 3; // Polygon
    uint8 constant public BURN_REQUEST_METADATA_TYPE = 153;
    uint8 constant public BURN_TO_CONTRACT_REQUEST_METADATA_TYPE = 154;
