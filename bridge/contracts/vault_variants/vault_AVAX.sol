...
contract VaultBSC {
    ...
    */
    uint8 constant public CURRENT_NETWORK_ID = 6; // AVAX
    uint8 constant public BURN_REQUEST_METADATA_TYPE = 160;
    uint8 constant public BURN_TO_CONTRACT_REQUEST_METADATA_TYPE = 162;
    ...
    */
    ...
    enum Prefix {
        ...
        AURORA_EXECUTE_SIGNATURE,
        AURORA_REQUEST_WITHDRAW_SIGNATURE,
        AVAX_EXECUTE_SIGNATURE,
        AVAX_REQUEST_WITHDRAW_SIGNATURE
    }
    ...
    function requestWithdraw(
        ...
        address verifier = verifySignData(abi.encode(newPreSignData(Prefix.AVAX_REQUEST_WITHDRAW_SIGNATURE, token, timestamp, amount), incognitoAddress), signData);
    ...
    function execute(
        ...
        address verifier = verifySignData(abi.encode(newPreSignData(Prefix.AVAX_EXECUTE_SIGNATURE, token, timestamp, amount), recipientToken, exchangeAddress, callData), signData);
