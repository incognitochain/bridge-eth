...
contract VaultBSC {
    ...
    */
    uint8 constant public CURRENT_NETWORK_ID = 5; // AURORA
    uint8 constant public BURN_REQUEST_METADATA_TYPE = 159;
    uint8 constant public BURN_TO_CONTRACT_REQUEST_METADATA_TYPE = 161;
